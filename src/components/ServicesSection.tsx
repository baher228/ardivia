    ...
    <section className="bg-[#f5f7f3] 2xl:py-16 md:py-12 py-10">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        <header className="text-center mb-12 md:mb-14">
          <h2 className="mx-auto max-w-4xl text-[22px] md:text-[28px] font-light leading-snug text-gray-800">
            Ardivia is an established landscape and garden design company; building and
            maintaining gardens and outdoor spaces in London and the Home Counties.
          </h2>
        </header>
